...
#include "ThirdPersonCharacterPlugin.generated.h"
...
UCLASS()
class CUSTOMTHIRDPERSONCHARACTER_API AThirdPersonCharacterPlugin : public ACharacter
{
    GENERATED_BODY()

public:
    AThirdPersonCharacterPlugin();
